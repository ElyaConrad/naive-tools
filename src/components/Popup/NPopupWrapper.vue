<!--<template>
  <div class="n-popup-wrapper" :class="{ [`type-${ type }`]: true }" :data-popup-id="id" :style="{ ['--max-offset' as string]: maxOffset, ['--header-sticky-offset' as string]: headerStickyOffset, ['--mask-offset' as string]: maskOffset, ['--level' as string]: level, ['--real-scroll-y' as string]: realScrollY }" @click="handleWrapperClick">
...
import { ref, useSlots, nextTick, watch, onMounted, VNode, watchEffect } from 'vue';
...
const props = defineProps<NPopupWrappedDescriptor>();
const emit = defineEmits(['close']);

/*watchEffect(() => {
  console.log('SLOT NODES', props.slotNodes);
});*/
...
<template>
  <div class="n-popup-wrapper" :class="{ [`type-${ type }`]: true }" :data-popup-id="id" :style="{ ['--min-offset' as string]: minOffset, ['--max-offset' as string]: maxOffset, ['--mask-offset' as string]: maskOffset, ['--level' as string]: level }" @click="handleWrapperClick">
